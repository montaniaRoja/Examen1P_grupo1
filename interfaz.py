...
def abrir_ventana1():
    ...
    if exists_id(restored_data, target_id):
        ...
        btn_reversion = tk.Button(ventana, text="Reversión", font=("Arial", 10, "bold"), command=lambda:[abrir_ventana3(datosClientes)])
...
def abrir_ventana2():
    ...
    global cuota
    cuota = tk.StringVar()
    txt_cuota = tk.Entry(ventana,textvariable=cuota,width=20, font=("Arial", 14), foreground="#ffac01", justify="center" )
    ...
    txt_idCliente = tk.Entry(ventana,textvariable=entradaFechaPago,width=20, font=("Arial", 14), foreground="#ffac01", justify="center" )
    txt_idCliente.pack()

    btn_pago = tk.Button(ventana, text="Realizar Pago", font=("Arial", 10, "bold"), command=lambda:[realizarPago(ventana)])
...
def abrir_ventana3(datosClientes):
    ...
    txt_referencia = tk.Entry(ventana,textvariable=referencia,width=20, font=("Arial", 14), foreground="#ffac01", justify="center" )
    txt_referencia.pack()
    ...
    txt_FechaReferencia = tk.Entry(ventana,textvariable=entradaFechaReferencia,width=20, font=("Arial", 14), foreground="#ffac01", justify="center" )
    txt_FechaReferencia.pack()

    btn_reversion = tk.Button(ventana, text="Aplicar Reversión", font=("Arial", 10, "bold"), command=lambda:[reversion(data, ventana)])
    btn_reversion.pack(side='left', expand=True,ipadx=30, ipady=20)
...
def crear_ventana():
    ...
    btn_actualizar = tk.Button(root, text="Actualizar Datos", font=("Arial", 10, "bold"), command=lambda:[cargarDatos(tree)])
    ...
    txt_idCliente = tk.Entry(root,textvariable=entrada,width=20, font=("Arial", 14), foreground="#ffac01", justify="center" )
    txt_idCliente.pack()
